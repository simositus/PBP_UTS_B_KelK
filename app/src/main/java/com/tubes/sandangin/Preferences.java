...
public class Preferences {
    ...
    static final String KEY_USER_TEREGISTER ="user", KEY_PASS_TEREGISTER ="pass", KEY_NAME_TEREGISTER ="name", KEY_EMAIL_TEREGISTER ="email";
    static final String KEY_USERNAME_SEDANG_LOGIN = "Username_logged_in";
    static final String KEY_NAME_SEDANG_LOGIN = "Name_logged_in";
    ...
    /** Deklarasi Edit Preferences dan mengubah data
     *  yang memiliki key isi KEY_NAME_TEREGISTER dengan parameter username */
    public static void setRegisteredName(Context context, String name){
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
    ...
    /** Deklarasi Edit Preferences dan mengubah data
     *  yang memiliki key isi KEY_EMAIL_TEREGISTER dengan parameter username */
    public static void setRegisteredEmail(Context context, String email){
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
        editor.putString(KEY_EMAIL_TEREGISTER, email);
        editor.apply();
    }
    /** Mengembalikan nilai dari key KEY_NAME_TEREGISTER berupa String */
    ...
    /** Deklarasi Edit Preferences dan mengubah data
     *  yang memiliki key KEY_NAME_SEDANG_LOGIN dengan parameter username */
    public static void setLoggedInName(Context context, String name){
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
        editor.putString(KEY_NAME_SEDANG_LOGIN, name);
        editor.apply();
    }
    /** Mengembalikan nilai dari key KEY_USERNAME_SEDANG_LOGIN berupa String */
    ...
    /** Deklarasi Edit Preferences dan mengubah data
     *  yang memiliki key KEY_EMAIL_SEDANG_LOGIN dengan parameter username */
    public static void setLoggedInEmail(Context context, String email){
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
        editor.putString(KEY_USERNAME_SEDANG_LOGIN, email);
        editor.apply();
    }
    /** Mengembalikan nilai dari key KEY_EMAIL_SEDANG_LOGIN berupa String */
